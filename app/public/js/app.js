...
(function() {
  ...
  angular.module('ehealth', ['ui.router', 'ui.bootstrap', 'ngAnimate']).constant('API_BASE_URL', '/api/').config(function($stateProvider, $httpProvider, $windowProvider, $urlRouterProvider) {
